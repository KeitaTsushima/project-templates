...
**Solution**: [How you fixed it] / [Workaround applied]
**Code reference**: `path/to/file.ts:123`

**Learning**: [What this taught you for future work]
